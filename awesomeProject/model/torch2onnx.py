...
def transform_to_onnx(weight_file, n_classes, IN_IMAGE_H, IN_IMAGE_W):
    model = C3D_model.C3D(num_classes=n_classes)
    ...
    x = torch.randn((1, 3, 16,IN_IMAGE_H, IN_IMAGE_W), requires_grad=True)
    onnx_file_name = "_models/C3D_none_3_16_{}_{}_dynamic_{}.onnx".format(IN_IMAGE_H, IN_IMAGE_W, n_classes)
...
if __name__ == '__main__':
    ...
    onnx_file_name = transform_to_onnx('_models/video_action_epoch-19.pth.tar',4,112,112)
