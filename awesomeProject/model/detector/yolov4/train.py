...
def train(model, device, config, epochs=10, save_cp=True, log_step=20, img_scale=0.5):
    ...
    val_loader = DataLoader(val_dataset, batch_size=config.batch // config.subdivisions, shuffle=False, num_workers=8,
...
def get_args(**kwargs):
    ...
    parser.add_argument('-val_label_path', dest='val_label', type=str, default='dev.txt', help="train label path")
    parser.add_argument(
